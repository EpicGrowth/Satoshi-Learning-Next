  ...
  const modules: ModuleInfo[] = [
    {
      ...
      icon: Scale,
      path: '/learn/bitcoin/bitcoin-economics/bitcoin-economics', // Adjusted path
      topics: [
    ...
    },
    {
      ...
      icon: Landmark,
      path: '/learn/bitcoin/bitcoin-economics/monetary-policy', // Adjusted path
      topics: [
    ...
    },
    {
      ...
      icon: LineChart,
      path: '/learn/bitcoin/bitcoin-economics/market-dynamics', // Adjusted path
      topics: [
    ...
    },
    {
      ...
      icon: CheckCircle,
      path: '/learn/bitcoin/bitcoin-economics/game-theory', // Adjusted path
      topics: [
    ...
    },
    {
      ...
      icon: Globe,
      path: '/learn/bitcoin/bitcoin-economics/economic-impact', // Adjusted path
      topics: [
