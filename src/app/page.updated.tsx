...
const bitcoinPath: Feature[] = [
  {
    icon: Book,
    title: 'Understand Bitcoin fundamentals and blockchain technology',
  ...
  {
    icon: Wallet,
    title: 'Master wallet management and private key security',
  ...
  {
    icon: Network,
    title: 'Set up and operate your own Bitcoin full node',
  ...
  {
    icon: Hash,
    title: 'See the advanced topics like mining and consensus',
...
export default function Home() {
  return (
    <div className="flex flex-col">
      {/* Extended background with honeycomb pattern for the entire page */}
