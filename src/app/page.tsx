...
const liquidPathFeatures: Feature[] = [
  {
    icon: Book,
    title: 'What is Liquid?',
    description: 'Introduction to the Liquid Network, its features, and architecture.',
  ...
  },
  {
    ...
    description: 'Learn how Liquid enables private-by-default transactions.',
    href: '/learn/liquid/liquid-fundamentals/confidential-transactions',
  },
  {
    icon: Layers,
    title: 'Asset Issuance',
    description: 'Explore how to issue and manage various types of assets on Liquid.',
    href: '/learn/liquid/liquid-fundamentals/asset-issuance',
  },
  {
    icon: Bitcoin, // Using Bitcoin icon for L-BTC
    title: 'L-BTC',
    description: 'Understand Liquid Bitcoin (L-BTC) and its role in the ecosystem.',
    href: '/learn/liquid/liquid-assets/l-btc',
  },
];
...
const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    description: 'Explore the Liquid sidechain for faster, confidential Bitcoin transactions and asset issuance.',
    icon: Droplet,
    features: liquidPathFeatures,
  },
];
