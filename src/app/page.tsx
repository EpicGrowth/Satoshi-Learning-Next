      ...
      <section className="container relative pt-12 pb-16 md:pt-16 md:pb-24">
        <div className="mx-auto flex max-w-[980px] flex-col items-center gap-8 text-center">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold leading-tight tracking-tight md:text-5xl lg:text-6xl font-display">
              Welcome to 
              <span className="block mt-2 font-brand whitespace-nowrap" style={{color: '#FF523C', fontWeight: 700, letterSpacing: '0.01em', textShadow: '0 0 1px rgba(255, 82, 60, 0.1)'}}>
                Satoshi Station
              </span>
            </h1>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <Button size="lg" className="gap-2 text-base font-medium" asChild>
