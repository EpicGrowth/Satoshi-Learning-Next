...
import { Bitcoin, Zap, Book, Menu, Search, Github } from 'lucide-react';
          ...
          <nav className="flex items-center space-x-6">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              {navigationItems.map((item) => {
                const basePath = pathname.startsWith('/learn') ? '/learn/' + pathname.split('/')[2] : pathname;
            ...
            <Button 
              ...
              className="bg-bitcoin-orange text-white hover:bg-bitcoin-hover hidden lg:inline-flex
                       transition-all duration-200 shadow-lg hover:shadow-bitcoin-orange/20"
              asChild
            >
