...
import { Landmark, Shield, Building, BarChart, Building2, Users } from 'lucide-react';

// Interactive component to visualize economic transformation
export const EconomicTransformationVisualizer = () => {
    ...
    <div className="p-4 bg-background rounded-lg border border-border">
      ...
      <div className="relative min-h-[400px] mb-4 border-4 border-muted/30 rounded-lg p-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div
            className={`col-span-3 mx-auto mb-6 w-48 ${activeView === 'bitcoin' ? 'bg-amber-50 dark:bg-amber-900/20' : 'bg-blue-50 dark:bg-blue-900/20'} p-3 rounded-lg border border-border shadow-sm`}
          >
            {activeView === 'traditional' ? (
