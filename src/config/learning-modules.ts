import { Bitcoin, Shield, TrendingUp, Server, Network, Cpu, Link, Lightbulb, Droplet } from 'lucide-react';
...
export const liquidModules: LearningModule[] = [
  {
