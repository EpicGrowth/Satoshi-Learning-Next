  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Bitcoin colors using the exact Satoshi Station orange
        bitcoin: {
          orange: "#FF523C", // Exact Satoshi Station orange from header
          deep: "#E64431",
          hover: "#FF6E5C",
          light: "#FFF0EE",
          dark: "#CC3F2E",
        },
        // Lightning colors - enhanced for better dark mode visibility
        lightning: {
          purple: "#9B59B6", // Brighter purple for better visibility
          deep: "#8E44AD",  // Original purple as secondary
          blue: "#3498DB",   // Brighter blue
          yellow: "#F1C40F", 
          green: "#2ECC71",  // Brighter green
          red: "#E74C3C",
          light: "#D6BCFF",  // Light purple for subtle accents
          dark: "#6C3483",   // Dark purple for shadows/borders
        },
